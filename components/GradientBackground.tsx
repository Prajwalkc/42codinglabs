...
export default function GradientBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {/* Large soft purple/magenta gradient glow from top right */}
      <div 
      ...
      <div 
        className="absolute top-0 right-0 w-[800px] h-[800px] rounded-full blur-[100px] opacity-50"
        style={{
      ...
      <div 
        className="absolute -bottom-[200px] -left-[300px] w-[1000px] h-[1000px] rounded-full blur-[100px] opacity-30"
        style={{
